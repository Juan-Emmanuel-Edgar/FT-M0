...
function colors(color) {
  ...
  switch (color) {
    case blue:"Thi is blue"
    case red:"Thi is red"  
      break;
  case green:"Thi is green"
  case orange: "Thi is orange"
...
//if(valor===true)return "Soy verdadero"; asi tambien esta completa la respuesta
}
